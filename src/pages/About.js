  ...
  const cards = [
    {
      ...
      description: "We combine web scraping, AI models, and government data to deliver precise predictions. Enter your address and view easy-to-understand graphs showcasing contamination risks",
    },
    {
      icon: Heart,
      title: "Health Care",
